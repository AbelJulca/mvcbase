$(function () {
    ...
    function ListarTablaPeriodo(periodo) {
        table = $('#datosConsulta').DataTable({
            ...
            "ajax": {
                'method': 'POST',
                'url': 'reportebajafac/listarVentaPeriodo',
        ...
        "dom": 'Bfrtip',
            ...
            buttons: [{
                ...
                {
                    extend: 'excelHtml5',
                    title: 'REPORTE_BAJA_FACTURA_SUNAT' + '_' + datetime,
        ...
        SendToSunat('#datosConsulta tbody');
        ...
        $(tbody).on('click', 'button.xml', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reportebajafac/rutaXml',{'ruta':ruta},function (e) {           
                        window.open('reportebajafac/rutaXml', '_blank');
                     });                  
                }
            })            
        });
    ...
    function cdrSunat(tbody) {
        $(tbody).on('click', 'button.cdr', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reportebajafac/rutaCdr',{'ruta':ruta},function (e) {           
                        window.open('reportebajafac/rutaCdr', '_blank');
                     });                  
                }
            })            
        });
    ...
    function SendToSunat (codigo) {
        ...
        let motivo = 'ERROR EN LA DIRECCION';      
