...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
  <div class="wrapper">
        ...
        <div class="container-fluid">
          <div class="row justify-content-end">
            <div class="col-md-12 mt-2 text-center text-primary">
              <h5 class="font-weight-bold">LISTA DE CLIENTES</h5>
            </div>
          </div>
          <div class="row mt-2">
            <div class="col-md-12">
              <div class="">
                <table id="datosCliente" class="table table-sm table-responsive-md" width="100%">
    ...
    <!-- /.content-wrapper -->
    <!-- Modal -->
        <div class="modal fade" id="clienteModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="clienteModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary font-weight-bold">AGREGAR CLIENTE</h5>
                    ...
                    <div class="modal-body">
                        <form id="frmCliente">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea rows="2" id="txtrazonsocial" name="txtrazonsocial" class="form-control form-control-sm mayus"></textarea>
                            </div>
    ...
    <!-- Fin Modal -->
        ...
        <div class="modal fade" id="clienteEditModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="clienteEditModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary font-weight-bold">AGREGAR CLIENTE</h5>
