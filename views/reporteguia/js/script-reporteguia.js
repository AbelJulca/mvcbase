$(function () {
    ...
    function ListarTablaPeriodo(periodo) {
        table = $('#datosConsulta').DataTable({
            ...
            "ajax": {
                'method': 'POST',
                'url': 'reporteguia/listarVentaPeriodo',
        ...
        "dom": 'Bfrtip',
            ...
            buttons: [{
                ...
                {
                    extend: 'excelHtml5',
                    title: 'REPORTE_GUIA_REMISION_SUNAT' + '_' + datetime,
    ...
    function xmlSunat(tbody) {
        $(tbody).on('click', 'button.xml', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reporteguia/rutaXml',{'ruta':ruta},function (e) {           
                        window.open('reporteguia/rutaXml', '_blank');
                     });                  
                }
            })            
        });
    ...
    function cdrSunat(tbody) {
        $(tbody).on('click', 'button.cdr', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reporteguia/rutaCdr',{'ruta':ruta},function (e) {           
                        window.open('reporteguia/rutaCdr', '_blank');
                     });                  
                }
            })            
        });
    ...
    function imprimirPDF (codigo) {
        $.post('reporteguia/pdf',{'codigo':codigo},function (e) {           
           window.open('reporteguia/pdf', '_blank');
        });               
    };
