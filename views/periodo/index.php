...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
  <div class="wrapper">
            ...
            <div class="col-md-12">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item font-weight-bold">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">PERIODO</a>
                </li>
                <li class="nav-item font-weight-bold">
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">EJERCICIO</a>
                </li>
                <!--                 <li class="nav-item">
                  ...
                  <div class="container-fluid">
                    <div class="row justify-content-end">
                      <div class="col-md-12 mt-2 text-center text-primary">
                        <h5 class="font-weight-bold">PERIODOS</h5>
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-md-12">
                        <div class="">
                          <table id="datosPeriodos" class="table table-sm table-responsive-md" width="100%">
                  ...
                  <div class="container-fluid">
                    <div class="row justify-content-end">
                      <div class="col-md-11 mt-2 text-center text-primary">
                        <h5 class="font-weight-bold">EJERCICIOS</h5>
                      </div>
                      <div class="col-md-1 mt-2">
                        <button id="btnAddejercicio" class="btn btn-info btn-sm" type="button" data-toggle="tooltip" data-placement="left" title="Agregar Ejercicio">
                    ...
                    <div class="row mt-2">
                      <div class="col-md-12">
                        <div class="">
                          <table id="datosEjercicios" class="table table-sm table-responsive-md" width="100%">
                            <thead class="thead-dark">
                              <tr>
                                <th scope="col">DESCRIPCION</th>
                                <th scope="col">AÑO</th>
    ...
    <!-- /.content-wrapper -->
    <!-- Modal -->
    <div class="modal fade" id="ejercicioModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="ejercicioModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-primary font-weight-bold">AGREGAR EJERCICIO</h5>
          ...
          <div class="modal-body">
            <form id="frmEjercicio">
              <div class="form-group mt-3">
                ...
                <textarea rows="2" id="txtdesccripcion" name="txtdesccripcion" class="form-control form-control-sm"></textarea>
              </div>
              <div class="form-row mt-3">
                <div class="col-md-6">
                  <label class="font-weight-bold">Año:</label>
                  <input type="text" maxlength="4" id="txtyear" name="txtyear" class="form-control form-control-sm" onKeyPress="return soloNumeros(event)" autocomplete="off" value="<?php echo date('Y') ?>">
                </div>
                <div class="col-md-6">
    ...
    <!-- Fin Modal -->
    <!-- Editar Periodo -->
    <div class="modal fade" id="ejercicioEditModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="ejercicioEditModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-primary font-weight-bold">EDITAR EJERCICIO</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="frmEjercicioEdit">
              <div class="form-group mt-3">
                <label class="font-weight-bold">Descripcion:</label>
                <input type="hidden" id="txtidejercicio" name="txtidejercicio"/>
                <textarea rows="2" id="txtdesccripcionEdit" name="txtdesccripcionEdit" class="form-control form-control-sm"></textarea>
              </div>
              <div class="form-row mt-3">
                <div class="col-md-6">
                  <label class="font-weight-bold">Año:</label>
                  <input type="text" maxlength="4" id="txtyearEdit" name="txtyearEdit" class="form-control form-control-sm" readonly="">
                </div>
                <div class="col-md-6">
                  <label class="text-white">Estado:</label>
                  <div class="custom-control custom-switch">
