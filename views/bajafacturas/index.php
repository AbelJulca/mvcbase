...
<head>
  ...
  <title>Codilans | Baja Factura</title>
...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="#" class="nav-link h6 m-0 font-weight-bold text-primary">BAJA FACTURAS</a>
        </li>
      </ul>
      <!-- Right navbar links -->
                ...
                <div class="col-md-12">
                    <table id="datosConsulta" class="table table-sm table-responsive-md" width="100%">
                        <thead class="thead-dark">
                            ...
                            <th scope="col">OP_EXO</th>
                            <th scope="col">OP_INA</th>
                            <th scope="col">IGV</th>
    ...
    <!-- Termina Modal de CARGAR -->

    <div class="modal fade" id="preguntarMotivo" tabindex="-1" role="dialog" aria-labelledby="preguntarMotivoTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" class="font-weight-bold">INGRESE UN MOVITO PARA BAJA</h5>
          ...
          <form id="frmEnviar">
            <div class="modal-body">
              ...
              <input type="text" class="form-control form-control-sm text-uppercase" id="txtmotivo" name="txtmotivo" autocomplete="off" required>
            </div>
            <div class="modal-footer">            
              <button type="submit" class="btn btn-primary">Enviar Baja</button>
            </div>
          </form>
        </div>
      </div>
