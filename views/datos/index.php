...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="../../index2.html"><b>Mis</b>Datos</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Valida Tus Datos</p>
        <form id="frmlogin" action="<?php echo URL ?>login/login">        
          <input type="hidden" name="txtcoduser" value="<?php echo Session::get('codUser') ?>">
          <label for="">Usuario:</label>
          <div class="input-group mb-3">            
            <input id="txtuser" name="txtuser" type="text" class="form-control" value="<?php echo Session::get('usuario')?>" disabled="true">
