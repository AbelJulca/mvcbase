$(function () {
    ...
    function ListarTablaPeriodo(periodo) {
        table = $('#datosConsulta').DataTable({
            ...
            "ajax": {
                'method': 'POST',
                'url': 'factura/listarVentaPeriodo',
        ...
        "dom": 'Bfrtip',
            ...
            buttons: [{
                ...
                {
                    extend: 'excelHtml5',
                    title: 'REPORTE_FACTURA_SUNAT' + '_' + datetime,
        ...
        $(tbody).on('click', 'button.xml', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('factura/rutaXml',{'ruta':ruta},function (e) {           
                        window.open('factura/rutaXml', '_blank');
                     });                  
                }
            })            
        });
    ...
    function cdrSunat(tbody) {
        $(tbody).on('click', 'button.cdr', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('factura/rutaCdr',{'ruta':ruta},function (e) {           
                        window.open('factura/rutaCdr', '_blank');
                     });                  
                }
            })            
        });
