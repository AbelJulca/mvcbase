$(function () {
    ...
    function ListarTablaPeriodo(periodo) {
        table = $('#datosConsulta').DataTable({
            ...
            "ajax": {
                'method': 'POST',
                'url': 'reportebajabol/listarVentaPeriodo',
        ...
        "dom": 'Bfrtip',
            ...
            buttons: [{
                ...
                {
                    extend: 'excelHtml5',
                    title: 'REPORTE_BAJA_BOLETAS_SUNAT' + '_' + datetime,
        ...
        $(tbody).on('click', 'button.xml', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reportebajabol/rutaXml',{'ruta':ruta},function (e) {           
                        window.open('reportebajabol/rutaXml', '_blank');
                     });                  
                }
            })            
        });
    ...
    function cdrSunat(tbody) {
        $(tbody).on('click', 'button.cdr', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reportebajabol/rutaCdr',{'ruta':ruta},function (e) {           
                        window.open('reportebajabol/rutaCdr', '_blank');
                     });                  
                }
            })            
        });
