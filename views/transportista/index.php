...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="#" class="nav-link h6 m-0 font-weight-bold text-primary">TRANSPORTISTA</a>
        </li>
      </ul>
    ...
    <!-- /.content-wrapper -->
    <!-- Modal -->
        <div class="modal fade" id="transportistaModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="transportistaModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary font-weight-bold">AGREGAR TRANSPORTISTA</h5>
                        ...
                        <form id="frmTransportista">
                            <div class="form-row">
                                <div class="col-md-5 col-5">
                                    ...
                                    <div id="cmbdocumento"></div>
                                </div>
                                <div class="col-md-7 col-7">
                                    <label class="font-weight-bold">Número:</label>
                                    <div class="form-row"> 
                                        <div class="col-md-7 col-7">
                                            <input type="text" maxlength="8" onKeyPress="return soloNumeros(event)" class="form-control form-control-sm" id="txtdni" name="txtdni" required="" autocomplete="off">                                                    
                                        </div>
                                        <div class="col-md-5 col-5">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input id="txtrazonsocial" name="txtrazonsocial" class="form-control form-control-sm text-uppercase" autocomplete="off" required>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea type="text" id="txtdireccion" name="txtdireccion" class="form-control form-control-sm mayus" autocomplete="off"></textarea>
                            </div>
                            <div class="form-row mt-3">
                                <div class="col-md-4">
                                    <label class="font-weight-bold">Placa:</label>
                                    <input type="text" id="txtplaca" name="txtplaca" class="form-control form-control-sm mayus" autocomplete="off" required>
                                </div>                               
                            </div>
    ...
    <!-- Fin Modal -->
        ...
        <div class="modal fade" id="transportistaEditModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="transportistaEditModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary font-weight-bold">EDITAR TRANSPORTISTA</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="frmEditTransportista">
                            <div class="form-row">
                                <div class="col-md-6 col-6">
                                    <label class="font-weight-bold">Documento:</label>
                                    <div id="cmbdocumentoEdit"></div>
                                </div>
                                <div class="col-md-6 col-6">
                                    <input type="hidden" id="txtidtranspor" name="txtidtranspor">
                                    <label class="font-weight-bold">Número:</label>
                                    <div class="form-row"> 
                                        <div class="col-md-12">
                                            <input type="text" maxlength="8" onKeyPress="return soloNumeros(event)" class="form-control form-control-sm" id="txtdniEdit" name="txtdniEdit" required="" autocomplete="off">                                                    
                                        </div>
                                    </div>
                                </div>                               
                            </div>
                            <div class="form-group mt-3">
                                <label class="font-weight-bold">Razon Social:</label>
                                <textarea rows="2" id="txtrazonsocialEdit" name="txtrazonsocialEdit" class="form-control form-control-sm mayus"></textarea>
                            </div>
                            <div class="form-row mt-3">
                                <div class="col-md-4">
                                    <label class="font-weight-bold">Telefono:</label>
                            ...
                            <div class="form-group mt-3">
                                <label class="font-weight-bold">Direccion:</label>
                                <textarea type="text" id="txtdireccionEdit" name="txtdireccionEdit" class="form-control form-control-sm mayus" autocomplete="off"></textarea>
                            </div>
                            <div class="form-row mt-3">
                                <div class="col-md-4">
                                    <label class="font-weight-bold">Placa:</label>
                                    <input type="text" id="txtplacaEdit" name="txtplacaEdit" class="form-control form-control-sm mayus" autocomplete="off" required>
                                </div>                               
                            </div>
                            <div class="modal-footer">                                
