                ...
                <tbody>
                    ...
                    foreach ($this->carrito as $key => $value):
                        ...
                        <tr>
                            ...
                            <th><small class="text-body"><?php echo round($value['precio'], 2) ?> </small></th>
                            <th><small class="text-body"><?php echo round($value['precio'] * $value['cantidad'], 2) ?> </small></th>
                            <th>
                                <button type="button" class="btn btn-danger btn-sm" onclick="dellItemCarrito('<?= $value['codigo'] ?>')"><i class="fas fa-trash-alt"></i></button>
                            </th>                            
                        </tr>
                        <?php
                        $cont = $cont + 1;
