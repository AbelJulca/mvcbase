$(function () {
    ...
    function ListarTablaPeriodo(periodo) {
        table = $('#datosConsulta').DataTable({
            ...
            "ajax": {
                'method': 'POST',
                'url': 'reportenotadebito/listarVentaPeriodo',
        ...
        "dom": 'Bfrtip',
            ...
            buttons: [{
                ...
                {
                    extend: 'excelHtml5',
                    title: 'REPORTE_NOTA_DEBITO_SUNAT' + '_' + datetime,
        ...
        $(tbody).on('click', 'button.xml', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reportenotadebito/rutaXml',{'ruta':ruta},function (e) {           
                        window.open('reportenotadebito/rutaXml', '_blank');
                     });                  
                }
            })            
        });
    ...
    function cdrSunat(tbody) {
        $(tbody).on('click', 'button.cdr', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    $.post('reportenotadebito/rutaCdr',{'ruta':ruta},function (e) {           
                        window.open('reportenotadebito/rutaCdr', '_blank');
                     });                  
                }
            })            
        });
