    ...
    function ListarTablaPeriodo(periodo) {
        ...
        "dom": 'Bfrtip',
            ...
            buttons: [{
                ...
                {
                    extend: 'excelHtml5',
                    title: 'REPORTE_BOLETA_SUNAT' + '_' + datetime,
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if(ruta === 'sin_ruta'){
                        ...
                        $.post('boleta/rutaXml',{'ruta':ruta},function (e) {           
                            window.open('boleta/rutaXml', '_blank');
                        });
                    }                                      
                }
            })            
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) { 
                    if (ruta === 'sin_ruta') {
                        ...
                        $.post('boleta/rutaCdr',{'ruta':ruta},function (e) {           
                            window.open('boleta/rutaCdr', '_blank');
                        });   
                    }                                     
                }
            })            
