...
<head>
  ...
  <title>Codilans | Reporte Nota Credito</title>
...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="#" class="nav-link h6 title-rx m-0 font-weight-bold text-primary">REPORTE NOTA CREDITO</a>
        </li>
      </ul>
      <!-- Right navbar links -->
