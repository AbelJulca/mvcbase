...
<head>
    ...
    <title>Data Cix | Categoria</title>
...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
    <div class="wrapper">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-11 mt-2 text-center text-primary">
                                    <h5 class="font-weight-bold">LISTA DE CATEGORIAS</h5>
                                </div>
                                <div class="col-md-1 mt-2">
                                    <button id="btnAddcategoria" class="btn btn-sm btn-info"
                            ...
                            <div class="">
                                <table id="datosCategoria"
                                    class="table table-sm table-responsive-md small"
                                    width="100%">
        ...
        <!-- /.content-wrapper -->
        <!-- Modal -->
        <div class="modal fade" id="categoriaModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            role="dialog" aria-labelledby="categoriaModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary font-weight-bold">AGREGAR CATEGORIA</h5>
                    ...
                    <div class="modal-body">
                        <form id="frmCategoria">
                            <div class="form-group">
                                ...
                                <input id="txtdescripcionC" name="txtdescripcionC"
        ...
        <div class="modal fade" id="categoriaEditModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            role="dialog" aria-labelledby="categoriaEditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-primary font-weight-bold">EDITAR CATEGORIA</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="frmEditCategoria">
                            <div class="form-group">
                                <input type="hidden" name="txtidcategoria" id="txtidcategoria">
                                <label class="font-weight-bold">Descripcion:</label>
                                <input id="txtdescripcionCEdit" name="txtdescripcionCEdit"
                                    class="form-control form-control-sm mayus" autocomplete="off" />
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary btn-sm" data-toggle="tooltip"
